...
[![Build Status Travis](https://travis-ci.com/bincrafters/conan-qt.svg?branch=stable%2F5.13.0-rc2)](https://travis-ci.com/bincrafters/conan-qt)
[![Build Status Azure](https://dev.azure.com/bincrafters/packages/_apis/build/status/bincrafters.conan-qt?branchName=stable%2F5.13.0-rc2)](https://dev.azure.com/bincrafters/packages/_build)
[![Build Status AppVeyor](https://ci.appveyor.com/api/projects/status/github/bincrafters/conan-qt?branch=stable%2F5.13.0-rc2&svg=true)](https://ci.appveyor.com/project/bincrafters/conan-qt)
...
### Basic setup
    ...
    $ conan install qt/5.13.0-rc2@bincrafters/stable
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    qt/5.13.0-rc2@bincrafters/stable
...
[MIT](https://github.com/bincrafters/conan-qt/blob/stable/5.13.0-rc2/LICENSE.md)
