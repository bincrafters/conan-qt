...
[![Build Status Travis](https://travis-ci.com/bincrafters/conan-qt.svg?branch=stable%2F5.14.0-rc)](https://travis-ci.com/bincrafters/conan-qt)
[![Build Status Azure](https://dev.azure.com/bincrafters/packages/_apis/build/status/bincrafters.conan-qt?branchName=stable%2F5.14.0-rc)](https://dev.azure.com/bincrafters/packages/_build)
[![Build Status AppVeyor](https://ci.appveyor.com/api/projects/status/github/bincrafters/conan-qt?branch=stable%2F5.14.0-rc&svg=true)](https://ci.appveyor.com/project/bincrafters/conan-qt)
...
### Basic setup
    ...
    $ conan install qt/5.14.0-rc@bincrafters/stable
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    qt/5.14.0-rc@bincrafters/stable
...
[MIT](https://github.com/bincrafters/conan-qt/blob/stable/5.14.0-rc/LICENSE.md)
